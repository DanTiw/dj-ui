...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 border border-black bg-[#FFD700] shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=checked]:bg-[#FFD700] data-[state=unchecked]:bg-black data-[state=unchecked]:translate-x-0"
      )}
    />
  </SwitchPrimitives.Root>
));
